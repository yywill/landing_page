...
const VerticalFeatures = () => (
  <Section
    ...
    description="
    Trustless Enterprise将会是一个完全构建在比特币之上的经济模型实体，这将会是我整篇文章的背景，也是我注册域名的由来。
